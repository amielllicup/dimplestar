  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center h-16">
      ...
      <div class="flex items-center">
        <a href="/dimplestar/admin/dashboard.php" class="flex items-center space-x-3">
          <img src="/dimplestar/images/logo.png" alt="Dimple Star" class="h-10 w-auto">
          <span class="text-white font-semibold text-lg">Dimple Star Transport - Admin</span>
        </a>
      </div>
      ...
      <div class="hidden md:block">
        <div class="ml-10 flex items-baseline space-x-4">
          ...
          <div class="relative group">
            <button class="text-white hover:bg-blue-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 flex items-center">
              Admin
            ...
            <div class="absolute left-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
              <a href="/dimplestar/admin/dashboard.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Dashboard</a>
              <a href="/dimplestar/admin/jeepneys.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Manage Jeepneys</a>
              <a href="/dimplestar/admin/drivers.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Manage Drivers</a>
              <a href="/dimplestar/admin/reports.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Reports</a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="md:hidden hidden" id="mobile-menu">
    <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-blue-700">
      ...
      <div class="border-t border-blue-500 pt-2 mt-2">
        <div class="text-blue-200 text-sm font-semibold px-3 py-2">Admin Panel</div>
        <a href="/dimplestar/admin/dashboard.php" class="text-white hover:bg-blue-600 block px-3 py-2 rounded-md text-base font-medium">Dashboard</a>
        <a href="/dimplestar/admin/jeepneys.php" class="text-white hover:bg-blue-600 block px-3 py-2 rounded-md text-base font-medium">Manage Jeepneys</a>
        <a href="/dimplestar/admin/drivers.php" class="text-white hover:bg-blue-600 block px-3 py-2 rounded-md text-base font-medium">Manage Drivers</a>
        <a href="/dimplestar/admin/reports.php" class="text-white hover:bg-blue-600 block px-3 py-2 rounded-md text-base font-medium">Reports</a>
      </div>
      <?php if(!isset($_SESSION['email'])): ?>
